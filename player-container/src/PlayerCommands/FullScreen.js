    ...
    if (fullScreen) {
      ...
      if (
        ...
        if (document.exitFullscreen) {
          document
            .exitFullscreen()
            .catch((err) =>
              console.warn("[FullScreen] exitFullscreen failed:", err.message),
            );
      ...
      if (isIOS && videoElement) {
        ...
        try {
          ...
          console.warn(
            "[FullScreen] Failed to enter fullscreen on video element:",
            error.message,
          );
        }
        ...
        try {
          ...
          console.warn(
            "[FullScreen] Failed to enter fullscreen on container:",
            error.message,
          );
        }
