...
- [`docs/DESCRIPTIONS_APP_ARCHITECTURE.md`](docs/DESCRIPTIONS_APP_ARCHITECTURE.md) — Architecture overview, data flow, timing system, and known issues
- [`docs/LINKEDIN_POST.md`](docs/LINKEDIN_POST.md) — LinkedIn post content about the app
...
This file is imported from the actual WordPress template which is named `descriptions.php`, so it is also 
...
```html
    <div id="root-descriptions" data-user="<?=$sessionId?>" data-theme="wallmuse"></div>
```

Please note:
* The ID of the element should be as shown above `root-descriptions`, otherwise the React app will not be able to render
...
/data/www/wallmuse-wp/wp-content/themes/neve-child-master/descriptions-assets
